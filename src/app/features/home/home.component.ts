      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div class="text-center">
          ...
          <p class="text-xl text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto">
            ...
            The modern project management tool built for developers.
          </p>
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            @if (!authService.isLoggedIn()) {
              <a routerLink="/auth/signup">
                <app-generic-button size="lg">Get Started Free</app-generic-button>
              </a>
              <a routerLink="/auth/login">
                <app-generic-button variant="outline" size="lg">Sign In</app-generic-button>
              </a>
            } @else {
              <a routerLink="/board">
                <app-generic-button size="lg">Go to Dashboard</app-generic-button>
              </a>
            }
          </div>
        </div>
